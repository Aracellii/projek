        ...
        <div class="row">
            <div class="col4">
                <div class="footer-desc">
                    <h3>Makanku</h3>
                    <p>
                    Restoran Makanku adalah tempat makan yang menyajikan berbagai hidangan dengan cepat dan praktis, ideal untuk pelanggan </div>
            </div>
            <div class="col2">
                <h3>Need Help?</h3>
                <ul>
